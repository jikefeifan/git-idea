...
<div class="container">
  <div class="row">
      ...
      <div class="col-lg-8">
          ...
          <form action="${pageContext.request.contextPath}/dept/deleteBatch" method="post" id="deleteBatchForm">
          <table border="1" class="table table-bordered table-hover">
              ...
              <tr>
                  ...
                  <td>${dept.email}</td>
                  <td><a class="btn btn-default btn-sm" href="${pageContext.request.contextPath}/account/findById?id=${dept.deptId}">修改</a>&nbsp;<a class="btn btn-default btn-sm" href="">删除</a></td>
              </tr>
              </c:forEach>
              <tr>
